...
| https://www.officedepot.com/a/products/7784160/APC-Back-UPS-900-9-Outlet1/ | APC Back-UPS 900 BVN900M1: genuine sale $99.99 (reg $124.99, exp 09/26/26) — a real 20% DROP, the only DROP verdict baseline.js has produced. But the spec table states "Automatic Voltage Regulation: No", failing that must-have outright; it's also a plain Standby-type "Back-UPS" (not "Back-UPS Pro"/"Smart-UPS"), APC's simulated/stepped-sine tier, with no pure-sine-wave claim on the page — fails that must-have too. Confirmed on page 2026-09-16. | 2026-09-16 |
| https://www.monoprice.com/product | Generic fallback URL with no SKU — Monoprice's extractor fails to find the real product link, so unrelated products share this one URL. Price history is nonsense: $69.99 (2026-08-03), $129.99 (08-04), $86.99, $57.99 (08-24), $256.99 (09-04), $113.99 (09-16), tagged alternately as item "hotspot-phone" and "ups". Not one listing moving — different products landing on the same broken URL. The false MOVED/-96.6% signal this produces is a scrape.js bug, not a price drop. | 2026-09-16 |
