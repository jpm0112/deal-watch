...
| https://www.monoprice.com/product | Extractor fallback URL, not a real product link — attempting to load it returns ERR_CONNECTION_RESET, so the listing can never be verified. Title (Eaton Tripp Lite 600VA/300W, 4 outlets) also fails the 6-outlet must-have and sits well under the ~1000-1500VA desktop tier even if the price were real. Same broken URL/title/$113.99 recurred 2026-09-10, -11, -14. | 2026-09-14 |
| https://www.officedepot.com/a/products/7784160/APC-Back-UPS-900-9-Outlet1/ | Genuine 20% sale confirmed on page ($124.99 reg -> $99.99, in stock, first-party Office Depot) — would otherwise be a DROP-tier hit — but the spec table itself states "Automatic Voltage Regulation: No" and "Number Of USB Ports: 0," failing two hard must-haves (AVR, USB data port for NUT/apcupsd). Basic Standby-type Back-UPS, not stated as pure sine wave either. | 2026-09-14 |
